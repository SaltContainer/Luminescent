...
namespace TMPro
{
    struct TextMeshProUGUI_Fields
    {
        // TODO: Add fields
    };

    struct TextMeshProUGUI_RGCTXs
    {
    };

    struct TextMeshProUGUI_VTable
    {
    ...
    struct TextMeshProUGUI_c
    {
        Il2CppClass_1 _1;
        struct TextMeshProUGUI_StaticFields* static_fields;
        TextMeshProUGUI_RGCTXs* rgctx_data;
        Il2CppClass_2 _2;
        TextMeshProUGUI_VTable vtable;
    };

    struct TextMeshProUGUI_o
    {
        TextMeshProUGUI_c *klass;
        void *monitor;
        TextMeshProUGUI_Fields fields;
    };

    struct TextMeshProUGUI_StaticFields
    {
